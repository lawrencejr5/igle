        ...
        <section className="feature-row">
          <div className="container feature-container">
            <div className="feature-text">
              ...
              <p>
                Commute with confidence. Fast, reliable, and comfortable rides
                at your fingertips. Wherever you're going, Igle connects you to
                the best drivers in your city.
              </p>
        ...
        <section className="feature-row reverse">
          <div className="container feature-container">
            <div className="feature-text">
              ...
              <p>
                Need something delivered ASAP? From documents to groceries, send
                packages across town in minutes with real-time tracking from
                pickup to drop-off.
              </p>
              <Link href="#" className="btn-pill">
                Send a package
        ...
        <section className="feature-row">
          <div className="container feature-container">
            <div className="feature-text">
              ...
              <p>
                Join our community of drivers and couriers. Drive with Igle and
                earn on your schedule. Enjoy flexible hours, instant payouts,
